...
public class DeliveredListFragment extends ListFragment implements LoaderManager.LoaderCallbacks<DataHandler>{
	private PacksListAdapter adapter;
	private SharedPreferences preferences;
	private Network netCheck;
	private static Activity mActivity;
	private static ListView mListView;
	public DeliveredListFragment(){} // this Fragment will be called from MainActivity
	...
	public Loader<DataHandler> onCreateLoader(int arg0, Bundle arg1) {
		LoadPacksList asynChro = new LoadPacksList(DeliveredListFragment.this.getActivity(), mActivity, mListView);
		String mobileNumber = preferences.getString(GlobalConstant.USER_MOBILE_NUMBER, "");
		asynChro.setMobileNumber(mobileNumber);
		asynChro.setUrlToGetAllPacks("http://omleteit.com/apps/pickpack/deliveredPacksList.php");
		asynChro.forceLoad();
		return asynChro;
	}
